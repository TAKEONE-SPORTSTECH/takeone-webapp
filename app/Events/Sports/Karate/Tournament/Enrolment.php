...
/**
 * Who may compete in a Karate championship, and in which weight division.
 *
    ...
    public function gate(ClubEvent $event, User $user, ?ClubEventRegistration $existing = null): EnrolmentDecision
    {
        ...
        if (! $user->gender || ! $user->birthdate) {
            return EnrolmentDecision::deny(
                'no_profile',
                __('event-karate_tournament::messages.gate_no_profile'),
            );
        }
        ...
        if (! $division) {
            return EnrolmentDecision::deny(
                ...
                $event->spectator_enabled
                    ? __('event-karate_tournament::messages.gate_no_division_spectator')
                    : __('event-karate_tournament::messages.gate_no_division'),
