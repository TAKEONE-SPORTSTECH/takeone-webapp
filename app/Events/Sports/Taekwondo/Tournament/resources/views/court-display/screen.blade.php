...
<title>{{ __('event-taekwondo_tournament::messages.screen_new_title') }}</title>
<style>
@php
...
<div id="wrap">
  ...
  <div class="title" id="title">{{ __('event-taekwondo_tournament::messages.screen_new_working') }}</div>
  <div class="spinner" id="spin"></div>
  <div class="hint" id="hint">{{ __('event-taekwondo_tournament::messages.screen_new_hint') }}</div>
  <button class="btn" id="retry" hidden>{{ __('event-taekwondo_tournament::messages.screen_new_retry') }}</button>
</div>
...
(function () {
  ...
  var T = {
    failed: @json(__('event-taekwondo_tournament::messages.screen_new_failed'))
  };
