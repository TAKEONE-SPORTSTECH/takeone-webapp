...
namespace App\Trainers\Controllers;
...
class TrainerController extends Controller
{
    ...
    private function renderProfile(User $user)
    {
        ...
        $skills = \App\Members\Models\SkillAcquisition::where('user_id', $user->id)
        ...
        $view = $isMobile && view()->exists('trainers::mobile.show') ? 'trainers::mobile.show' : 'trainers::show';
