...
<title>{{ __('scoreboard::taekwondo_messages.screen_new_title') }}</title>
<style>
@php
...
<body>
<div id="wrap">
  <div class="eyebrow">{{ __('scoreboard::taekwondo_messages.pair_eyebrow') }}</div>
  <div class="title" id="title">{{ __('scoreboard::taekwondo_messages.screen_new_working') }}</div>
  <div class="spinner" id="spin"></div>
  <div class="hint" id="hint">{{ __('scoreboard::taekwondo_messages.screen_new_hint') }}</div>
  <button class="btn" id="retry" hidden>{{ __('scoreboard::taekwondo_messages.screen_new_retry') }}</button>
</div>
...
(function () {
  ...
  var KEY = 'takeone.court.token';
  var ENROLL = @json(route('court-display.enroll', [], false));
  var BOARD = @json(url('/court'));
  var T = {
    failed: @json(__('scoreboard::taekwondo_messages.screen_new_failed'))
  };
