{{--
    ...
    It belongs to Karate. The Taekwondo package has its own copy of this file
...
--}}
@once('karate-winner-celebration-styles')
<style>
@php
...
@font-face {
  ...
  src: url("{{ route('karate-court-display.font', 'poppins-italic-'.$wcWeight.'-'.$wcSubset.'.woff2', false) }}") format('woff2');
...
@once('karate-winner-celebration-script')
<script>
