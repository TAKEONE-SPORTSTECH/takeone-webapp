...
@include('clubs::financials.partials.auto-expense-modal')
@include('clubs::financials.partials.export-modal')
@include('clubs::financials.partials.edit-modal')
@include('clubs::financials.partials.delete-modal')
@include('clubs::financials.partials.transaction-detail-modal')
@include('clubs::financials.partials.refund-modal')
@include('clubs::financials.partials.mode-review-modal')
