    ...
    <div class="flex min-h-full items-end justify-center sm:items-center sm:p-4">
        <div x-show="open"
            ...
            <div class="flex-shrink-0 px-5 pt-3 pb-4 rounded-t-3xl sm:rounded-t-2xl text-white relative overflow-hidden"
                ...
                <div class="relative flex items-start gap-3">
                    ...
                    <div class="min-w-0 flex-1">
                        <h3 class="text-lg font-black leading-tight truncate">{{ __('admin.ins_add') }}</h3>
            ...
            <form x-ref="form" method="POST" action="{{ route('admin.club.instructors.store', $club->slug) }}"
                ...
                @include('clubs::instructors.partials.compensation-fields')

                <div x-show="staffType === 'instructor'" x-transition>
                    @include('clubs::instructors.partials.package-slots-fields')
                </div>
            </form>
