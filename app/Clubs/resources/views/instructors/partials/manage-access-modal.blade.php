{{-- "Manage Access" modal for the Instructors/Staff page's 3-dot menu. Reuses the
     ...
     (the Clubs module's club-roles admin: admin.club.roles.member.permissions /
     admin.club.roles.member.permissions.store), packaged standalone since staff may not have a club
