            ...
            <div class="flex min-h-full items-end justify-center sm:items-center sm:p-4">
                <div x-show="showModal"
                    ...
                    <div class="flex-shrink-0 px-5 pt-3 pb-4 rounded-t-3xl sm:rounded-t-2xl text-white relative overflow-hidden"
                        ...
                        <div class="relative flex items-start gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <h3 class="text-lg font-black leading-tight truncate"><span x-text="isEdit ? '{{ __('admin.ach_edit') }}' : '{{ __('admin.ach_add') }}'"></span></h3>
                                <p class="text-[12px] text-white/85 mt-0.5 truncate">{{ $club->name }}</p>
                            </div>
                            <button type="button" @click="showModal = false" aria-label="{{ __('shared.close') }}"
                    ...
                    <form :action="formAction" method="POST" enctype="multipart/form-data" id="achievementMobileForm" class="flex-1 overflow-y-auto overscroll-contain px-4 py-4">
                        ...
                        @include('clubs::achievements.partials.form-fields')
                    </form>
