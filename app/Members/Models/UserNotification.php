        ...
        try {
            if (function_exists('Realtime') && Realtime()->enabled()) {
                ...
                Realtime()->publishToUser($userId, 'notifications', [
                    ...
                    // Time-critical: an athlete called to the mat. The native
                    // service posts these on their own high-importance channel,
                    // so somebody who silences routine notifications still hears
                    // the one that means "you are fighting now". Everything else
                    // stays in the ordinary lane, which is what keeps that lane
                    // worth listening to.
