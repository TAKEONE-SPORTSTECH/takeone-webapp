...
class PersonalMobileController extends Controller
{
    ...
    public function home(Request $request): View
    {
        ...
        $personalPosts = \App\Members\Models\UserPost::where('user_id', $user->id)
            ->visibleTo($user)
        ...
        $blockedIds = \App\Members\Models\UserBlock::where('blocker_id', $user->id)->pluck('blocked_id')
            ->merge(\App\Members\Models\UserBlock::where('blocked_id', $user->id)->pluck('blocker_id'));

        $audience = $followIds->unique()->diff($blockedIds)->values();

        $followingPosts = $audience->isEmpty()
            ? collect()
            : \App\Members\Models\UserPost::whereIn('user_id', $audience)
                ->visibleTo($user)
        ...
        $suggestions = \App\Members\Models\User::whereIn('id', $mateIds)
        ...
        $memberFeed = \App\Members\Models\UserPost::whereIn('user_id', $allMemberIds)
            ->visibleTo($user)
        ...
        return view($isMobile ? 'members::personal.mobile.home' : 'members::personal.desktop.home', $viewData);
    }
    ...
    public function schedule(Request $request): View
    {
        ...
        return view($isMobile ? 'members::personal.mobile.schedule' : 'members::personal.desktop.schedule', $viewData);
    }
    ...
    public function scheduleShow(int $session, Request $request): View
    {
        ...
        return view($isMobile ? 'members::personal.mobile.schedule-show' : 'members::personal.desktop.schedule-show', $viewData);
    }
    ...
    public function substituteSearch(Request $request, string $token): JsonResponse
    {
        ...
        $users = \App\Members\Models\User::query()
            ->whereKeyNot(Auth::id())
    ...
    public function substituteAssign(Request $request, string $token): JsonResponse
    {
        ...
        $sub = \App\Members\Models\User::find($data['substitute_user_id']);
    ...
    public function scheduleSyncedShow(Request $request, string $token): View
    {
        ...
        $trainerUser = $trainerUid ? \App\Members\Models\User::find($trainerUid) : null;
        ...
        $myReview = $rateCi
            ? \App\Trainers\Models\InstructorReview::where('instructor_id', $rateCi->id)->where('reviewer_user_id', Auth::id())->first()
            : null;
        ...
        return view($isMobile ? 'members::personal.mobile.schedule-show' : 'members::personal.desktop.schedule-show', [
    ...
    public function rateClassTrainer(Request $request, string $token): JsonResponse
    {
        ...
        \App\Trainers\Models\InstructorReview::updateOrCreate(
    ...
    private function avatarUrl(?\App\Members\Models\User $u): ?string
    {
    ...
    public function affiliations(): View
    {
        ...
        return view('members::personal.affiliations', compact('active', 'left'))
    ...
    private function profileLegacy(): View
    {
        ...
        return view('members::profile.mobile.show', [
            'inShell' => true,
    ...
    public function packages(Request $request): View
    {
        ...
        return view($isMobile ? 'members::personal.mobile.packages' : 'members::personal.desktop.packages', compact('subscriptions'));
    }
    ...
    public function progress(): View
    {
        ...
        return view('members::personal.progress', compact('goals', 'goalStats'));
    }
    ...
    public function videos(Request $request): View
    {
        ...
        return view($isMobile ? 'members::personal.mobile.videos' : 'members::personal.desktop.videos', [
            'shelves' => $shelves,
    ...
    public function payments(): View
    {
        ...
        return view('members::personal.payments', compact('subscriptions', 'totalPaid', 'totalDue'));
    }
    ...
    public function settlePayment(Request $request, \App\Models\ClubMemberSubscription $subscription): JsonResponse
    {
        ...
        $isGuardian = ! $isSelf && \App\Members\Models\UserRelationship::where('guardian_user_id', $actor->id)
    ...
    public function demoFeed(?\App\Members\Models\User $me = null): array
    {
        $now = \Carbon\Carbon::now();
    ...
    public function challenge(): View
    {
        ...
        return view('challenges::challenge', compact('challenges', 'duels'));
    }
    ...
    public function challengeShow(int $challenge): View
    {
        ...
        return view('challenges::challenge-show', ['c' => $c]);
    }
    ...
    public function duelShow(int $duel): View
    {
        ...
        return view('challenges::duel-show', ['d' => $d]);
    }
    ...
    public function challengeCreate(): View
    {
        ...
        return view('challenges::challenge-create', compact('opponents', 'athletes'));
    }
    ...
    public function challengeHistory(): View
    {
        ...
        return view('challenges::challenge-history', compact('duels', 'solo'));
    }
    ...
    public function settings(Request $request): View
    {
        ...
        return view($isMobile ? 'members::personal.mobile.settings' : 'members::personal.desktop.settings', compact('user'));
    }
