...
class UserPostController extends Controller
{
    ...
    public function show(UserPost $post): View
    {
        ...
        if ($author) {
            $blocked = \App\Members\Models\UserBlock::where(function ($q) use ($viewer, $author) {
        ...
        return view('members::personal.post', [
    ...
    public function vote(Request $request, UserPost $post): JsonResponse
    {
        ...
        \App\Members\Models\UserPostPollVote::updateOrCreate(
    ...
    public function comment(Request $request, UserPost $post): JsonResponse
    {
        ...
        $blockedWithCommenter = \App\Members\Models\UserBlock::idsBlockedEitherWayWith(Auth::id());
        $this->broadcastPost(
    ...
    public function view(UserPost $post): JsonResponse
    {
        ...
        if ($post->user_id !== $viewer->id) {
            \App\Members\Models\UserPostView::firstOrCreate([
    ...
    {
        return \App\Members\Models\UserFollow::where('followee_id', $authorId)->pluck('follower_id');
    }
}
