...
class InvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('members::invoices._list', $viewData);
        }

        return view('members::invoices.index', $viewData);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        if ($request->ajax()) {
            return response()->json(['html' => view('members::invoices._show_modal', compact('invoice'))->render()]);
        }

        return view('members::invoices.show', compact('invoice'));
    }
    ...
    public function receipt(Request $request, $id)
    {
        ...
        if ($request->has('download')) {
            $html = view('members::invoices.receipt', compact('invoice'))->render();
        ...
        return view('members::invoices.receipt', compact('invoice'));
    }
