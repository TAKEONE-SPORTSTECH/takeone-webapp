                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="flex gap-2 flex-wrap" id="instructors-list-{{ $affiliation->id }}" style="{{ count($affInstructors) ? '' : 'display:none;' }}">
                                                        @foreach($affInstructors as $i => $ins)
                                                            @php
                                                                $linkedUser = $ins['user_id'] ? \App\Members\Models\User::find($ins['user_id']) : null;
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                                                ...
                                                <div class="grid grid-cols-12 gap-2 mb-3">
                                                    @php
                                                        $instructorSkills = \App\Members\Models\SkillAcquisition::where('instructor_id', $instructor->id)->get();
                                                                                ...
                                                                                <div class="flex items-start mb-2">
                                                                                    ...
                                                                                    <div class="grow">
                                                                                        ...
                                                                                        @php
                                                                                            ...
                                                                                            $activitySkills = \App\Members\Models\SkillAcquisition::where('activity_id', $pkgActivity->activity_id)
