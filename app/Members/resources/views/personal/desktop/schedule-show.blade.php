...
<div class="px-4 sm:px-6 lg:px-8 py-6"
    ...
    <a href="{{ route('me.schedule', ['day' => $s['day'] ?? null]) }}" class="inline-flex items-center justify-center w-9 h-9 rounded-full text-sm font-semibold text-muted-foreground hover:text-primary transition-colors mb-4"
           aria-label="{{ __('nav.tab_schedule') }}" title="{{ __('nav.tab_schedule') }}">
