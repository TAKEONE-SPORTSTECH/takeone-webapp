             ...
             x-data="{
                ...
                async weigh(uid) {
                    ...
                    try {
                        ...
                        const d = await this.send(`{{ url('testcode/me/events/'.$e['key'].'/verify') }}/${g.reg_id}/weigh-in`, body);
                ...
                async pay(uid, approve) {
                    ...
                    this.busy = uid;
                    try {
                        const d = await this.send(`{{ url('testcode/me/events/'.$e['key'].'/verify') }}/${g.reg_id}/payment`, { approve });
