...
window.TOB = {
    ...
    data:        @json(route('testcode.me.events.bout.video.data', ['event' => $e['key'], 'matchNo' => $bout['match_no']])),
    notes:       @json(route('testcode.me.events.bout.notes.store', ['event' => $e['key'], 'matchNo' => $bout['match_no']])),
    comments:    @json(route('testcode.me.events.bout.comments.store', ['event' => $e['key'], 'matchNo' => $bout['match_no']])),
...
window.addEventListener('load', window._vdbScheduleOverflowCheck);
    ...
    <div id="ytcList">
        @forelse ($comments as $c)
            @include('eventlab::personal.mobile.partials.bout-comment', ['c' => $c, 'isReply' => false])
        @empty
            ...
            <div class="mrv-video" id="mrvVideoSlot"></div>
                ...
                <div class="mrv" id="matchReview">
                    ...
                    <div class="mrv-pane mrv-pane-flush is-on" data-mrv-panel="match">
                        @include('eventlab::personal.mobile.partials.bout-match-card')
                    </div>
