            ...
            <div class="relative w-full bg-white rounded-t-3xl max-h-[88vh] flex flex-col"
                ...
                <div class="flex-shrink-0 px-5 pt-3 pb-4 rounded-t-3xl text-white relative overflow-hidden"
                    ...
                    <div class="relative flex items-start gap-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <h3 class="text-lg font-black leading-tight">{{ __('market.pay_title') }}</h3>
                            <p class="text-[12px] text-white/85 mt-0.5">{{ $p['name'] }}</p>
                        </div>
                        <button type="button" @click="paySheet=false" aria-label="{{ __('shared.close') }}"
