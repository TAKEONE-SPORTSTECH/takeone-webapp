        ...
        <div class="flex items-center justify-between relative z-50">
            ...
            @if ($canManage)
                ...
                <div x-data="boutEditor(@js($bout), {
                         update: @js(route('testcode.me.events.bout.update', ['event' => $e['key'], 'matchNo' => $bout['match_no']])),
                         competitors: @js(route('testcode.me.events.bout.competitors', ['event' => $e['key'], 'matchNo' => $bout['match_no']])),
                         officials: @js(route('testcode.me.events.officials', $e['key'])),
                     }, {
            ...
            @if ($bout['video_url'])
                ...
                <a href="{{ $bout['video_url'] }}"
                   @if ($boutVideoIsOurs) data-shell-link data-route="testcode.me.events" @else target="_blank" rel="noopener" @endif
                   class="w-10 h-10 rounded-full bg-white/15 border border-white/25 backdrop-blur grid place-items-center flex-shrink-0"
