...
<div x-data="courtScreens({
        ...
        listUrl: @js(route('testcode.me.events.screens', $event)),
        pairUrl: @js(route('testcode.me.events.screens.pair', $event)),
        base: @js(url('testcode/me/events/'.$event.'/screens')),
        cameras: @js(array_values($cameras)),
        cameraMax: @js((int) $cameraMax),
        camerasUrl: @js(route('testcode.me.events.cameras', $event)),
        camerasBase: @js(url('testcode/me/events/'.$event.'/cameras')),
