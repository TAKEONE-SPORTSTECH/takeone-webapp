...
<div x-data="eventDocuments({
        ...
        storeUrl: @js(route('testcode.me.events.documents.store', $event)),
     })"
    ...
    <div x-show="open" x-cloak class="fixed inset-0" style="z-index:75" @keydown.escape.window="open = false">
        ...
        <div x-show="open"
            ...
            <div class="flex-shrink-0 px-5 pt-3 pb-4 rounded-t-3xl text-white relative overflow-hidden"
                 style="background: linear-gradient(150deg, {{ $docColor }}, {{ $docColor }}b0);">
                ...
                <div class="relative flex items-start gap-3">
                    ...
                    <div class="min-w-0 flex-1">
                        <h3 class="text-lg font-black leading-tight">{{ __('personal.event_manage_documents') }}</h3>
                        <p class="text-[12px] text-white/85 mt-0.5">{{ __('personal.event_docs_hint') }}</p>
                    </div>
