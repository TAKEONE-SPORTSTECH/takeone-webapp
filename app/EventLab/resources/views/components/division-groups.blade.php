...
<div x-data="divisionGroups({
        ...
        avatars: @js($avatars),
        urls: {
            store: @js(route('testcode.me.events.divisions.store', $event)),
            base:  @js(route('testcode.me.events.divisions.store', $event)),
            // Registering somebody who is not on the platform at all.
            enter: @js(route('testcode.me.events.entries.unnamed', $event)),
        },
        words: @js([
