...
<div x-data="eventChecklist({
        ...
        storeUrl: @js(route('testcode.me.events.checklist.store', $event)),
        startUrl: @js(route('testcode.me.events.start', $event)),
        base: @js(url('testcode/me/events/'.$event.'/checklist')),
     })"
