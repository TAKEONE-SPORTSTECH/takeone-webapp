...
namespace App\Challenges\Controllers;
...
use App\Challenges\Models\DuelWitness;
...
class ChallengeController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view($isMobile ? 'challenges::mobile.challenge' : 'challenges::desktop.challenge', compact('challenges', 'duels'));
    }
    ...
    public function duel(Duel $duel, Request $request): View
    {
        ...
        return view($isMobile ? 'challenges::mobile.duel-show' : 'challenges::desktop.duel-show', ['d' => $d]);
    }
    ...
    public function create(): View
    {
        ...
        return view('challenges::challenge-create', compact('opponents', 'athletes', 'myAvatar', 'facilities', 'events'));
    }
    ...
    public function history(Request $request): View
    {
        ...
        return view($isMobile ? 'challenges::mobile.challenge-history' : 'challenges::desktop.challenge-history', compact('duels', 'solo'));
    }
    ...
    private function notify(?int $userId, string $action, Duel $duel, User $actor, string $text): void
    {
        ...
        try {
            \App\Members\Models\UserNotification::notifyUser($userId, $action, ($actor->full_name ?? $actor->name).' '.$text, [
                'actor_id' => $actor->id,
