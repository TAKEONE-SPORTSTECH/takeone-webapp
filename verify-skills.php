...
echo "\n=== Summary ===\n";
echo "Total skill records: " . \App\Members\Models\SkillAcquisition::count() . "\n";
echo "Unique skill names: " . \App\Members\Models\SkillAcquisition::distinct('skill_name')->count('skill_name') . "\n";
