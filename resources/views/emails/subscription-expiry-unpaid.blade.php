...
<head>
    ...
    <title>Package Expiry & Payment Reminder</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Membership Renewal & Payment Reminder</p>
        </div>
        <div class="content">
            ...
            <div class="alert-box">
                ...
                <p>💳 You also have an outstanding balance on your account.</p>
            </div>
            ...
            <div class="balance-box">
                ...
                <span>{{ number_format($subscription->amount_due, 2) }}</span>
            </div>
            ...
            <p style="color: #555555; line-height: 1.7; font-size: 14px;">
                ...
                please renew your membership and settle your outstanding balance before the expiry date.
            </p>

            <div class="button-container">
                <a href="{{ $subscription->tenant->url() }}" class="button">Renew & Pay Now</a>
            </div>

            <div class="divider"></div>

            <p style="color: #aaaaaa; font-size: 13px; text-align: center; margin: 0;">
                If you have already settled your balance, please disregard this message or contact your club admin.
            </p>
        </div>
        <div class="footer">
