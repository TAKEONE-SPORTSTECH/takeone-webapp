            ...
            <div class="flex-1 overflow-y-auto px-6 py-6">
                ...
                <div x-show="joinModal.step === 'select-members'" x-transition>
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl font-bold mb-1">Who would you like to register?</h2>
                ...
                <div x-show="joinModal.step === 'package-selection'" x-transition>
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl font-bold mb-1">Select Packages</h2>
                ...
                <div x-show="joinModal.step === 'payment-review'" x-transition>
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl font-bold mb-1">Review & Payment</h2>
