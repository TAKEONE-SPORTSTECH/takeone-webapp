...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <div class="flex justify-between items-center mb-4">
        <h1 class="mb-0 text-2xl font-bold">Family</h1>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
        ...
        @foreach($dependents as $relationship)
            <div>
                <a href="{{ route('family.show', $relationship->dependent->id) }}" class="no-underline">
                    ...
                    <div class="px-4 py-3 flex-1">
                        <div class="grid grid-cols-2 gap-3 mb-3">
                            <div>
                                ...
                                <div class="font-semibold text-gray-500 capitalize">{{ $relationship->dependent->gender == 'm' ? 'Male' : 'Female' }}</div>
                            </div>
                            <div>
                                <div class="text-xs text-gray-500 uppercase font-medium mb-1" style="letter-spacing: 0.5px;">Age</div>
                                <div class="font-semibold text-gray-500">{{ $relationship->dependent->age }} years</div>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-3 mb-3">
                            <div>
        ...
        <div>
            <a href="{{ route('family.create') }}" class="no-underline">
                <div class="bg-white rounded-lg h-full shadow-sm border-2 border-dashed border-gray-300 add-card">
                    <div class="text-center flex flex-col justify-center items-center h-full cursor-pointer p-6">
                        ...
                        <h5 class="font-semibold text-gray-500">Add Family Member</h5>
                    </div>
                </div>
            </a>
        </div>
