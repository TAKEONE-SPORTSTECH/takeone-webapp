...
@section('title', __('personal.event_manage_verification'))

{{--
    The officials' desk — the roster with its two gates on the rows.

    Officials only; the guard is in PersonalEventController@verify. The public
    reading surface is a different screen (personal.event-people) with no
    controls on it at all, which is why this one can be entirely about the work.

    It sits inside the event-show Alpine state (partials.event-show-script)
    ...
    <header class="m-hero px-5 pt-5 pb-10 text-white relative overflow-hidden"
        ...
        <div class="relative z-10 mt-5">
            ...
            <h1 class="text-2xl font-black mt-1 leading-tight">
                {{ __('personal.event_manage_verification') }}
            </h1>
