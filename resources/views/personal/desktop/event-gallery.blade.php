...
<div class="px-4 sm:px-6 lg:px-8 py-6"
     x-data="eventGalleryDesktop(@js($divisions), @js($stages), @js(route('me.events.gallery.data', $e['key'])), @js($e['key']))"
     x-init="boot()">
    ...
    <header class="m-hero -mx-4 sm:-mx-6 lg:-mx-8 -mt-6 px-8 pt-7 pb-16 text-white relative overflow-hidden"
        ...
        <div class="flex items-center justify-between gap-3 relative z-50">
            <a href="{{ route('me.events.show', $e['key']) }}"
               class="inline-flex items-center gap-2 h-10 ps-3 pe-4 rounded-full bg-white/15 border border-white/25 backdrop-blur text-white text-sm font-semibold no-underline hover:bg-white/25 transition-colors">
