    ...
    <div class="tf-auth-box">
        <div class="tf-auth-card">
            ...
            <div class="text-center mb-6">
                ...
                {{-- Form state --}}
                <p class="text-center text-gray-500 text-lg mb-8 tracking-tight">{{ __('auth.auth_forgot_password_title') }}</p>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="mb-4">
                        <input id="email" type="email"
                               ...
                               name="email"
                               value="{{ old('email') }}"
                               placeholder="{{ __('auth.auth_forgot_password_email_placeholder') }}"
                    ...
                    <button type="submit" class="tf-auth-btn mt-2 mb-6">
                        {{ __('auth.auth_forgot_password_send_reset_link') }}
                    </button>
                </form>

                <p class="text-center text-sm text-gray-500">
                    <a href="{{ route('login') }}" class="tf-auth-link">{{ __('auth.auth_forgot_password_back_to_login') }}</a>
                </p>
