            ...
            @foreach($clubs as $club)
                <div class="club-card-wrapper"
                    ...
                    <div class="card border shadow-sm overflow-hidden club-card cursor-pointer transition-all duration-300">
                        <!-- Cover Image -->
                        <div class="relative overflow-hidden h-48" onclick="window.location.href='{{ route('admin.club.dashboard', $club) }}'">
                            @if($club->cover_image)
                        ...
                        <!-- Card Body -->
                        <div class="p-4 bg-white" onclick="window.location.href='{{ route('admin.club.dashboard', $club) }}'">
                            <div class="mb-3">
                                <!-- Club Name -->
