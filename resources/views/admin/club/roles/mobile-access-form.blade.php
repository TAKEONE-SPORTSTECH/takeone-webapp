            ...
            <div class="flex-shrink-0 px-5 pt-3 pb-4 rounded-t-3xl sm:rounded-t-2xl text-white relative overflow-hidden"
                ...
                <div class="relative flex items-start gap-3">
                    ...
                    <div class="min-w-0 flex-1">
                        <h3 class="text-lg font-black leading-tight truncate"><span x-text="userName || '{{ __('admin.role_manage_access') }}'"></span></h3>
                        <p class="text-[12px] text-white/85 mt-0.5 truncate">{{ __('admin.role_manage_access') }}</p>
                    </div>
