...
<div class="bg-white rounded-lg shadow">
    ...
    <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4">
        <h5 class="text-lg font-semibold text-gray-900">Club Gallery</h5>
        <button class="inline-flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-primary/90 transition-colors"
